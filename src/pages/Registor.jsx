     ...
     <div className="bg-linear-90 from-purple-400 to-pink-300 min-h-screen flex items-center justify-center">
        <div className="mx-auto w-114 bg-white rounded-lg p-10 my-5">
            ...
            <form>
                ...
                <button className="mt-5 border-2 outline-none  bg pl-4 text-base py-2.5 hover:bg-purple-800 duration-300 w-full rounded-lg font-semibold text-white bg-purple-600">Ro'yxatdan o'tish</button>
