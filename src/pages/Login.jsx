...
const Login = () => {
  ...
  return (
    <div className="bg-linear-to-br from-purple-600 to-blue-500 min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white p-10 rounded-4xl shadow-2xl relative overflow-hidden">
        {/* Dekorativ element */}
