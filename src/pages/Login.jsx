...
const Login = () => {
  ...
  return (
    <div className="bg-linear-to-br from-purple-600 via-purple-500 to-blue-500 min-h-screen flex items-center justify-center p-4">
      {/* max-w-md va rounded o'lchamlari mobilda moslashuvchan qilindi */}
      <div className="w-full max-w-110 bg-white p-6 md:p-10 rounded-[30px] md:rounded-[40px] shadow-2xl relative overflow-hidden">
