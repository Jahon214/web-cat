        ...
        <div className="md:col-span-2 bg-white p-10 rounded-[40px] border border-gray-50 shadow-2xl shadow-purple-900/5 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <div className="h-14 flex items-center gap-3 px-6 bg-emerald-50 rounded-2xl border border-emerald-100">
          ...
          <div className="pt-4">
            <button 
              type="submit"
              className="w-full bg-linear-to-r from-purple-600 to-indigo-600 text-white py-5 rounded-2xl font-black uppercase tracking-[3px] shadow-xl shadow-purple-200 hover:scale-[1.02] transition-all active:scale-95 flex items-center justify-center gap-4 group"
            >
