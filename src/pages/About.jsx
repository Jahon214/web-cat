...
const About = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-12 font-sans">
      ...
      {/* --- HERO SECTION --- */}
      <div className="relative overflow-hidden bg-linear-to-br from-[#9333EA] to-[#4F46E5] rounded-[35px] md:rounded-[50px] p-8 md:p-20 text-white mb-12 md:mb-16 shadow-2xl shadow-purple-200">
        ...
        <FaPaw className="absolute -bottom-2.5 -right-2.5 md:-bottom-5 md:-right-5 text-[150px] md:text-[300px] opacity-10 rotate-12" />
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6 mb-16 md:mb-24">
        {features.map((f) => (
          ...
          >
            <div
              className={`w-10 h-10 md:w-14 md:h-14 bg-linear-to-br ${f.color} rounded-xl md:rounded-2xl flex items-center justify-center text-white text-lg md:text-2xl mb-4 md:mb-6 group-hover:rotate-12 transition-transform`}
            >
              {f.icon}
            </div>
        ...
        <div className="bg-white rounded-[35px] md:rounded-[45px] p-6 md:p-10 border border-gray-50 shadow-xl shadow-gray-100/50 flex flex-col justify-center">
          ...
          <div className="space-y-3 md:space-y-4">
            ...
            <div className="flex items-center gap-4 p-4 md:p-5 bg-gray-50 rounded-[20px] md:rounded-[25px] border border-transparent shadow-sm">
              ...
              <span className="text-sm md:text-base text-gray-700 font-medium">Navoiy shahri, NSU binosi</span>
            </div>
          </div>
        </div>

        {/* Xarita (Map) */}
        <div className="rounded-[35px] md:rounded-[45px] overflow-hidden min-h-62.5 md:min-h-100 shadow-2xl border-8 border-white group">
          <iframe
