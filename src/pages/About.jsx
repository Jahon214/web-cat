...
const About = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      {/* Asosiy Qism */}
      <div className="bg-linear-to-r from-[#9333EA] to-[#A855F7] rounded-3xl p-8 md:p-12 text-white mb-12 shadow-xl shadow-purple-200">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
        {features.map((f) => (
          <div
            key={f.id}
            className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:translate-y-1.25 transition-all"
          >
