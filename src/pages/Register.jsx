...
const Register = () => {
  ...
  return (
    <div className="bg-linear-to-br from-purple-600 via-purple-500 to-pink-400 min-h-screen flex items-center justify-center p-4 md:p-6">
      <div className="w-full max-w-xl bg-white p-6 md:p-12 rounded-[30px] md:rounded-[40px] shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-3 md:space-y-4">
            ...
            <button
              disabled={loading}
              className={`group relative w-full py-3.5 md:py-4 mt-4 rounded-xl md:rounded-2xl font-black text-white shadow-xl transition-all duration-300 active:scale-95 overflow-hidden cursor-pointer ${loading ? "bg-gray-400 cursor-not-allowed" : "bg-linear-to-r from-purple-600 to-purple-500 shadow-purple-200 hover:shadow-purple-300"}`}
              type="submit"
            >
