...
const Register = () => {
  ...
  return (
    <div className="bg-linear-to-br from-purple-600 via-purple-500 to-pink-400 min-h-screen flex items-center justify-center p-6">
              ...
              className={`
                ...
                ${
                  loading
                    ...
                    : "bg-linear-to-r from-purple-600 to-purple-500 shadow-purple-200 hover:shadow-purple-300 hover:-translate-y-1"
                }
              `}
              type="submit"
            >
