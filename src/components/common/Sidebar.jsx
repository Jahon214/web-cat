...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <aside className="hidden lg:flex fixed top-16 left-0 bottom-0 z-20 w-1/5 bg-linear-to-b from-purple-700 to-blue-600 p-4 flex-col gap-2">
        {menuItems.map((item) => (
          <Link
            key={item.path}
            to={item.path}
      ...
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-100 bg-white h-17.5 flex justify-around items-center px-4 rounded-t-[30px] border-t border-gray-100 shadow-[0_-10px_30px_rgba(0,0,0,0.08)]">
        {menuItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {active && (
                <div className="absolute -top-7.5 w-14 h-14 bg-linear-to-tr from-purple-600 to-blue-500 rounded-full border-[5px] border-white shadow-lg shadow-purple-200 flex items-center justify-center transition-all duration-500 animate-pop">
