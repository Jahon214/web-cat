...
const Header = () => {
  ...
  return (
    <header className="h-16 bg-linear-to-r from-purple-700 to-blue-600 text-white flex items-center justify-between px-4 md:px-8 shadow-lg z-60 sticky top-0">
