    ...
    <header className="h-16 md:h-20 text-white flex items-center justify-between px-4 md:px-10 shadow-2xl z-60 sticky top-0 border-b border-white/5 backdrop-blur-md bg-[#0f172a]/95">
      ...
      <div className="flex items-center gap-8">
        <Link to="/admin" className="flex items-center gap-2.5 group">
          <div className="w-10 h-10 bg-linear-to-tr from-purple-600 to-blue-500 rounded-xl flex items-center justify-center shadow-lg shadow-purple-500/20 group-hover:rotate-12 transition-transform duration-300">
      ...
      <div className="flex items-center gap-2 md:gap-6">
        ...
        <div className="h-10 md:h-12 flex items-center gap-2 md:gap-3 bg-white/5 p-1 md:pr-4 rounded-2xl border border-white/10 hover:bg-white/10 transition-all cursor-pointer">
          <div className="w-8 h-8 md:w-10 md:h-10 bg-linear-to-br from-purple-500 to-indigo-600 rounded-xl flex items-center justify-center text-white shadow-inner">
