...
const AdminSidebar = () => {
  ...
  return (
    <div className="w-1/5 shrink-0">
      <aside className="fixed top-16 left-0 bottom-0 z-20 w-1/5 bg-linear-to-b from-gray-900 to-purple-950 p-4 flex flex-col gap-2 shadow-2xl border-r border-white/5">
          ...
          {menuItems.map((item) => (
            <Link
              ...
              className={`flex items-center gap-4 px-5 py-4 rounded-2xl transition-all duration-300 group ${
                isActive(item.path)
                  ? "bg-linear-to-r from-purple-600 to-indigo-600 text-white shadow-lg shadow-purple-900/40 scale-[1.02]"
        ...
        <div className="mt-auto pb-4 opacity-20 group text-center">
           <div className="h-px w-full bg-linear-to-r from-transparent via-white to-transparent mb-4"></div>
